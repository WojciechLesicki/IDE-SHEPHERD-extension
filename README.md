...
| **Enable**            | **Opt-in:** `ide-shepherd.gitHookAdvisory.enabled` (default `false`) → Reload Window               |
...
npx @vscode/vsce package --no-dependencies --out ide-shepherd-extension-3.1.4.vsix
```
